...
FetchContent_Declare(
    vendor_stm32cubewba
    GIT_REPOSITORY https://github.com/STMicroelectronics/STM32CubeWBA.git
    GIT_TAG        main
)
FetchContent_MakeAvailable(vendor_stm32cubewba)

add_library(${PROJECT_NAME} STATIC
    ${CMAKE_CURRENT_SOURCE_DIR}/src/stm32/stm32wba/cfn_hal_uart.c
)

# Include Vendor SDK headers
target_include_directories(${PROJECT_NAME} PRIVATE
    ${vendor_stm32cubewba_SOURCE_DIR}/Drivers/STM32WBAxx_HAL_Driver/Inc
    ${vendor_stm32cubewba_SOURCE_DIR}/Drivers/CMSIS/Device/ST/STM32WBAxx/Include
    ${vendor_stm32cubewba_SOURCE_DIR}/Drivers/CMSIS/Include
)
