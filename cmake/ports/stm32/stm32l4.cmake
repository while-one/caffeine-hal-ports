...
FetchContent_MakeAvailable(vendor_stm32cubel4)

add_library(${PROJECT_NAME} STATIC
    ${CMAKE_CURRENT_SOURCE_DIR}/src/stm32/stm32l4/cfn_hal_uart.c
)

# Include Vendor SDK headers
target_include_directories(${PROJECT_NAME} PRIVATE
    ${vendor_stm32cubel4_SOURCE_DIR}/Drivers/STM32L4xx_HAL_Driver/Inc
    ${vendor_stm32cubel4_SOURCE_DIR}/Drivers/CMSIS/Device/ST/STM32L4xx/Include
    ${vendor_stm32cubel4_SOURCE_DIR}/Drivers/CMSIS/Include
)
