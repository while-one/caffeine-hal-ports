...
FetchContent_MakeAvailable(vendor_stm32cubel0)

add_library(${PROJECT_NAME} STATIC
    ${CMAKE_CURRENT_SOURCE_DIR}/src/stm32/stm32l0/cfn_hal_uart.c
)

# Include Vendor SDK headers
target_include_directories(${PROJECT_NAME} PRIVATE
    ${vendor_stm32cubel0_SOURCE_DIR}/Drivers/STM32L0xx_HAL_Driver/Inc
    ${vendor_stm32cubel0_SOURCE_DIR}/Drivers/CMSIS/Device/ST/STM32L0xx/Include
    ${vendor_stm32cubel0_SOURCE_DIR}/Drivers/CMSIS/Include
)
