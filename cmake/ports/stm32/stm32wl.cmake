...
FetchContent_Declare(
    vendor_stm32cubewl
    GIT_REPOSITORY https://github.com/STMicroelectronics/STM32CubeWL.git
    GIT_TAG        main
)
FetchContent_MakeAvailable(vendor_stm32cubewl)

add_library(${PROJECT_NAME} STATIC
    ${CMAKE_CURRENT_SOURCE_DIR}/src/stm32/stm32wl/cfn_hal_uart.c
)

# Include Vendor SDK headers
target_include_directories(${PROJECT_NAME} PRIVATE
    ${vendor_stm32cubewl_SOURCE_DIR}/Drivers/STM32WLxx_HAL_Driver/Inc
    ${vendor_stm32cubewl_SOURCE_DIR}/Drivers/CMSIS/Device/ST/STM32WLxx/Include
    ${vendor_stm32cubewl_SOURCE_DIR}/Drivers/CMSIS/Include
)
