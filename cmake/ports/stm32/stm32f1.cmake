...
FetchContent_MakeAvailable(vendor_stm32cubef1)

add_library(${PROJECT_NAME} STATIC
    ${CMAKE_CURRENT_SOURCE_DIR}/src/stm32/stm32f1/cfn_hal_uart.c
)

# Include Vendor SDK headers
target_include_directories(${PROJECT_NAME} PRIVATE
    ${vendor_stm32cubef1_SOURCE_DIR}/Drivers/STM32F1xx_HAL_Driver/Inc
    ${vendor_stm32cubef1_SOURCE_DIR}/Drivers/CMSIS/Device/ST/STM32F1xx/Include
    ${vendor_stm32cubef1_SOURCE_DIR}/Drivers/CMSIS/Include
)
