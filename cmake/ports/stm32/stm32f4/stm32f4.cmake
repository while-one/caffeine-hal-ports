...
macro(cfn_add_stm32f4_module FLAG_NAME ST_NAME VENDOR_FILES PORT_FILES)
    # Port files are ALWAYS added to ensure construct/destruct symbols exist
    foreach(PFILE IN ITEMS ${PORT_FILES})
        set(PFILE_ABS "${PROJECT_SOURCE_DIR}/${PFILE}")
        list(FIND PORT_SOURCES_LIST "${PFILE_ABS}" _PINDEX)
        if(_PINDEX EQUAL -1)
            list(APPEND PORT_SOURCES_LIST "${PFILE_ABS}")
        endif()
    endforeach()

    if(CFN_HAL_${FLAG_NAME} STREQUAL "ON")
        if(CMAKE_CROSSCOMPILING)
            foreach(VFILE IN ITEMS ${VENDOR_FILES})
                list(APPEND VENDOR_SOURCES_LIST "${HAL_SRC_DIR}/${VFILE}")
            endforeach()
        endif()
        set(HAL_${ST_NAME}_MODULE_ENABLED 1)
    else()
        set(HAL_${ST_NAME}_MODULE_ENABLED 0)
    endif()
endmacro()
...
cfn_add_stm32f4_module(ADC    ADC    "stm32f4xx_hal_adc.c;stm32f4xx_hal_adc_ex.c" "src/stm32/stm32f4/cfn_hal_adc_port.c")
cfn_add_stm32f4_module(CAN    CAN    "stm32f4xx_hal_can.c"                        "src/stm32/stm32f4/cfn_hal_can_port.c")
cfn_add_stm32f4_module(CLOCK  RCC    ""                                           "src/stm32/stm32f4/cfn_hal_clock_port.c")
cfn_add_stm32f4_module(COMP   COMP   "stm32f4xx_hal_comp.c"                       "src/stm32/stm32f4/cfn_hal_comp_port.c")
cfn_add_stm32f4_module(CRYPTO CRYP   "stm32f4xx_hal_cryp.c;stm32f4xx_hal_cryp_ex.c" "src/stm32/stm32f4/cfn_hal_crypto_port.c")
cfn_add_stm32f4_module(DAC    DAC    "stm32f4xx_hal_dac.c;stm32f4xx_hal_dac_ex.c" "src/stm32/stm32f4/cfn_hal_dac_port.c")
cfn_add_stm32f4_module(DMA    DMA    "stm32f4xx_hal_dma.c;stm32f4xx_hal_dma_ex.c" "src/stm32/stm32f4/cfn_hal_dma_port.c")
cfn_add_stm32f4_module(ETH    ETH    "stm32f4xx_hal_eth.c"                        "src/stm32/stm32f4/cfn_hal_eth_port.c")
cfn_add_stm32f4_module(GPIO   GPIO   "stm32f4xx_hal_gpio.c"                       "src/stm32/stm32f4/cfn_hal_gpio_port.c")
cfn_add_stm32f4_module(I2C    I2C    "stm32f4xx_hal_i2c.c;stm32f4xx_hal_i2c_ex.c" "src/stm32/stm32f4/cfn_hal_i2c_port.c")
cfn_add_stm32f4_module(I2S    I2S    "stm32f4xx_hal_i2s.c;stm32f4xx_hal_i2s_ex.c" "src/stm32/stm32f4/cfn_hal_i2s_port.c")
cfn_add_stm32f4_module(IRQ    EXTI   ""                                           "src/stm32/stm32f4/cfn_hal_irq_port.c")
cfn_add_stm32f4_module(NVM    FLASH  ""                                           "src/stm32/stm32f4/cfn_hal_nvm_port.c")
cfn_add_stm32f4_module(PWM    TIM    "stm32f4xx_hal_tim.c;stm32f4xx_hal_tim_ex.c" "src/stm32/stm32f4/cfn_hal_pwm_port.c")
cfn_add_stm32f4_module(QSPI   QSPI   "stm32f4xx_hal_qspi.c"                       "src/stm32/stm32f4/cfn_hal_qspi_port.c")
cfn_add_stm32f4_module(RTC    RTC    "stm32f4xx_hal_rtc.c;stm32f4xx_hal_rtc_ex.c" "src/stm32/stm32f4/cfn_hal_rtc_port.c")
cfn_add_stm32f4_module(SDIO   SD     "stm32f4xx_hal_sd.c;stm32f4xx_ll_sdmmc.c"    "src/stm32/stm32f4/cfn_hal_sdio_port.c")
cfn_add_stm32f4_module(SPI    SPI    "stm32f4xx_hal_spi.c"                        "src/stm32/stm32f4/cfn_hal_spi_port.c")
cfn_add_stm32f4_module(TIMER  TIM    "stm32f4xx_hal_tim.c;stm32f4xx_hal_tim_ex.c" "src/stm32/stm32f4/cfn_hal_timer_port.c")
cfn_add_stm32f4_module(UART   UART   "stm32f4xx_hal_uart.c"                       "src/stm32/stm32f4/cfn_hal_uart_port.c")
cfn_add_stm32f4_module(UART   USART  "stm32f4xx_hal_usart.c"                      "src/stm32/stm32f4/cfn_hal_uart_port.c")
cfn_add_stm32f4_module(USB    PCD    "stm32f4xx_hal_pcd.c;stm32f4xx_hal_pcd_ex.c;stm32f4xx_ll_usb.c" "src/stm32/stm32f4/cfn_hal_usb_port.c")
cfn_add_stm32f4_module(WDT    IWDG   "stm32f4xx_hal_iwdg.c;stm32f4xx_hal_wwdg.c"  "src/stm32/stm32f4/cfn_hal_wdt_port.c")
