...
FetchContent_MakeAvailable(vendor_stm32cubewb)

add_library(${PROJECT_NAME} STATIC
    ${CMAKE_CURRENT_SOURCE_DIR}/src/stm32/stm32wb/cfn_hal_uart.c
)

# Include Vendor SDK headers
target_include_directories(${PROJECT_NAME} PRIVATE
    ${vendor_stm32cubewb_SOURCE_DIR}/Drivers/STM32WBxx_HAL_Driver/Inc
    ${vendor_stm32cubewb_SOURCE_DIR}/Drivers/CMSIS/Device/ST/STM32WBxx/Include
    ${vendor_stm32cubewb_SOURCE_DIR}/Drivers/CMSIS/Include
)
