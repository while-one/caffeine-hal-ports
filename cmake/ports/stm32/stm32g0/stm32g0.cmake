...
FetchContent_MakeAvailable(vendor_stm32cubeg0)

add_library(${PROJECT_NAME} STATIC
    ${CMAKE_CURRENT_SOURCE_DIR}/src/stm32/stm32g0/cfn_hal_uart.c
)

# Include Vendor SDK headers
target_include_directories(${PROJECT_NAME} PRIVATE
    ${vendor_stm32cubeg0_SOURCE_DIR}/Drivers/STM32G0xx_HAL_Driver/Inc
    ${vendor_stm32cubeg0_SOURCE_DIR}/Drivers/CMSIS/Device/ST/STM32G0xx/Include
    ${vendor_stm32cubeg0_SOURCE_DIR}/Drivers/CMSIS/Include
)
