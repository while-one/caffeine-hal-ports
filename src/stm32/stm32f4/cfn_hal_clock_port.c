...
{
    CFN_HAL_UNUSED(driver);
    if (!freq_hz) { return CFN_HAL_ERROR_BAD_PARAM; }
    *freq_hz = HAL_RCC_GetSysClockFreq();
    return CFN_HAL_ERROR_OK;
}

static cfn_hal_error_code_t port_clock_get_peripheral_freq(cfn_hal_clock_t *driver, uint32_t peripheral_id, uint32_t *freq_hz)
{
    CFN_HAL_UNUSED(driver);
...
void cfn_hal_port_clock_enable_gate(cfn_hal_port_peripheral_id_t periph_id)
{
    ...
    {
#if defined(GPIOA)
        case CFN_HAL_PORT_PERIPH_GPIOA: __HAL_RCC_GPIOA_CLK_ENABLE(); break;
#endif
#if defined(GPIOB)
        case CFN_HAL_PORT_PERIPH_GPIOB: __HAL_RCC_GPIOB_CLK_ENABLE(); break;
#endif
#if defined(GPIOC)
        case CFN_HAL_PORT_PERIPH_GPIOC: __HAL_RCC_GPIOC_CLK_ENABLE(); break;
#endif
#if defined(GPIOD)
        case CFN_HAL_PORT_PERIPH_GPIOD: __HAL_RCC_GPIOD_CLK_ENABLE(); break;
#endif
#if defined(GPIOE)
        case CFN_HAL_PORT_PERIPH_GPIOE: __HAL_RCC_GPIOE_CLK_ENABLE(); break;
#endif
#if defined(GPIOF)
        case CFN_HAL_PORT_PERIPH_GPIOF: __HAL_RCC_GPIOF_CLK_ENABLE(); break;
#endif
#if defined(GPIOG)
        case CFN_HAL_PORT_PERIPH_GPIOG: __HAL_RCC_GPIOG_CLK_ENABLE(); break;
#endif
#if defined(GPIOH)
        case CFN_HAL_PORT_PERIPH_GPIOH: __HAL_RCC_GPIOH_CLK_ENABLE(); break;
#endif
#if defined(GPIOI)
        case CFN_HAL_PORT_PERIPH_GPIOI: __HAL_RCC_GPIOI_CLK_ENABLE(); break;
#endif
#if defined(GPIOJ)
        case CFN_HAL_PORT_PERIPH_GPIOJ: __HAL_RCC_GPIOJ_CLK_ENABLE(); break;
#endif
#if defined(GPIOK)
        case CFN_HAL_PORT_PERIPH_GPIOK: __HAL_RCC_GPIOK_CLK_ENABLE(); break;
#endif
#if defined(USART1)
        case CFN_HAL_PORT_PERIPH_USART1: __HAL_RCC_USART1_CLK_ENABLE(); break;
#endif
#if defined(USART2)
        case CFN_HAL_PORT_PERIPH_USART2: __HAL_RCC_USART2_CLK_ENABLE(); break;
#endif
#if defined(USART3)
        case CFN_HAL_PORT_PERIPH_USART3: __HAL_RCC_USART3_CLK_ENABLE(); break;
#endif
#if defined(UART4)
        case CFN_HAL_PORT_PERIPH_UART4: __HAL_RCC_UART4_CLK_ENABLE(); break;
#endif
#if defined(UART5)
        case CFN_HAL_PORT_PERIPH_UART5: __HAL_RCC_UART5_CLK_ENABLE(); break;
#endif
#if defined(USART6)
        case CFN_HAL_PORT_PERIPH_USART6: __HAL_RCC_USART6_CLK_ENABLE(); break;
#endif
#if defined(UART7)
        case CFN_HAL_PORT_PERIPH_UART7: __HAL_RCC_UART7_CLK_ENABLE(); break;
#endif
#if defined(UART8)
        case CFN_HAL_PORT_PERIPH_UART8: __HAL_RCC_UART8_CLK_ENABLE(); break;
#endif
#if defined(UART9)
        case CFN_HAL_PORT_PERIPH_UART9: __HAL_RCC_UART9_CLK_ENABLE(); break;
#endif
#if defined(UART10)
        case CFN_HAL_PORT_PERIPH_UART10: __HAL_RCC_UART10_CLK_ENABLE(); break;
#endif
#if defined(SPI1)
        case CFN_HAL_PORT_PERIPH_SPI1: __HAL_RCC_SPI1_CLK_ENABLE(); break;
#endif
#if defined(SPI2)
        case CFN_HAL_PORT_PERIPH_SPI2: __HAL_RCC_SPI2_CLK_ENABLE(); break;
#endif
#if defined(SPI3)
        case CFN_HAL_PORT_PERIPH_SPI3: __HAL_RCC_SPI3_CLK_ENABLE(); break;
#endif
#if defined(SPI4)
        case CFN_HAL_PORT_PERIPH_SPI4: __HAL_RCC_SPI4_CLK_ENABLE(); break;
#endif
#if defined(SPI5)
        case CFN_HAL_PORT_PERIPH_SPI5: __HAL_RCC_SPI5_CLK_ENABLE(); break;
#endif
#if defined(SPI6)
        case CFN_HAL_PORT_PERIPH_SPI6: __HAL_RCC_SPI6_CLK_ENABLE(); break;
#endif
#if defined(I2C1)
        case CFN_HAL_PORT_PERIPH_I2C1: __HAL_RCC_I2C1_CLK_ENABLE(); break;
#endif
#if defined(I2C2)
        case CFN_HAL_PORT_PERIPH_I2C2: __HAL_RCC_I2C2_CLK_ENABLE(); break;
#endif
#if defined(I2C3)
        case CFN_HAL_PORT_PERIPH_I2C3: __HAL_RCC_I2C3_CLK_ENABLE(); break;
#endif
#if defined(ADC1)
        case CFN_HAL_PORT_PERIPH_ADC1: __HAL_RCC_ADC1_CLK_ENABLE(); break;
#endif
#if defined(ADC2)
        case CFN_HAL_PORT_PERIPH_ADC2: __HAL_RCC_ADC2_CLK_ENABLE(); break;
#endif
#if defined(ADC3)
        case CFN_HAL_PORT_PERIPH_ADC3: __HAL_RCC_ADC3_CLK_ENABLE(); break;
#endif
#if defined(DAC)
        case CFN_HAL_PORT_PERIPH_DAC1: __HAL_RCC_DAC_CLK_ENABLE(); break;
#endif
#if defined(CAN1)
        case CFN_HAL_PORT_PERIPH_CAN1: __HAL_RCC_CAN1_CLK_ENABLE(); break;
#endif
#if defined(CAN2)
        case CFN_HAL_PORT_PERIPH_CAN2: __HAL_RCC_CAN2_CLK_ENABLE(); break;
#endif
#if defined(ETH_MAC_BASE)
        case CFN_HAL_PORT_PERIPH_ETH: __HAL_RCC_ETHMAC_CLK_ENABLE(); break;
#endif
#if defined(TIM1)
        case CFN_HAL_PORT_PERIPH_TIM1: __HAL_RCC_TIM1_CLK_ENABLE(); break;
#endif
        default: break;
    }
}
